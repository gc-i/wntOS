...
from ..view.Ui_MeterDialog import *
...
from ..model.core_classes import CoMeter, ClMeterClass, ClMeterType, MxApplication
from sqlalchemy.exc import SQLAlchemyError
from ..model.DatabaseHelper import *
from qgis.core import QgsFeatureRequest


class MeterDialog(QDialog, Ui_MeterDialog, DatabaseHelper):
    ...
    def __init__(self, layer, feature_id, attr_update=False, parent=None):
        ...
        self.damage_form = DamageForm('co_meter', self.__feature_id)
        self.tabWidget.addTab(self.damage_form, 'Damages')
        self.maintenance_form = MaintenanceForm('co_meter', self.__feature_id)
        self.tabWidget.addTab(self.maintenance_form, 'Maintenance')
        self.document_form = DocumentForm('co_meter', self.__feature_id)
        self.tabWidget.addTab(self.document_form, 'Documents')
        self.customer_form = CustomerManagementForm(CoMeter, self.__feature_id)
    ...
    def accept(self):
        ...
        self.__layer.beginEditCommand('Update attributes (co_meter)')
    ...
    def keyPressEvent(self, e):
        ...
        if e.key() == Qt.Key_F1:
            ...
            if tab_index == 0:
                PluginUtils.show_help("Add_Edit_Meter.htm")
            elif tab_index == 1:
